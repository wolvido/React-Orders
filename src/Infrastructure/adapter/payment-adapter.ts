import {CashPayment, ChequePayment, BankTransferPayment, PaymentGateway } from "@/src/entities/payment-method/type/payment-method";
...
export function convertCashPaymentToPaymentDTO(cashPayment: CashPayment): PaymentDTO {
    return {
        ...
        sys_DeletedTimeStamp: new Date().toLocalISOString(),
        ...
        paymentDate: new Date().toLocalISOString(),
        paymentType: "Cash",
        cashierShiftId: 0,
        referenceNumber: "",
        approvalCode: "",
