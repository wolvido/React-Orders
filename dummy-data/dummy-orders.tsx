...
export const loadOrders = async () => {
    try {
        ...
        // Get orders and transform dates
        ...
        // If your orderType has dates (like for bank transfers or cheques), handle those too
        orders = orders.map(order => ({
            ...order,
            orderType: {
                ...order.orderType,
                // Check and convert specific payment method dates
